...
<html lang="es">
    ...
    <script src="resources/prestamo.js" type="text/javascript"></script>
    ...
    <div class="row">
        ...
        <%
            if(request.getAttribute("libros")==null)
                response.sendRedirect("ControlPrestamo?mostrar=1");
                
        %>
    <div class="col-md-6">
            
                
                    <h1>Detalle Prestamo</h1>
                    <div class="row">
                ...
                <table class="table table-bordered" id="data" width="100%" cellspacing="0">
                    ...
                    <%
                        if(request.getAttribute("detalleLibro")!=null){
                            ArrayList<DetallePrestamo> a= new ArrayList<DetallePrestamo>();
                            a.addAll((Collection)request.getAttribute("detalleLibro"));
                            for(DetallePrestamo ob:a){
                                
                                out.println("<tr>"+
					"<td>"+ob.getId_detalle_prestamo()+"</td>"+
    ...
    <div class="col-md-6">
                ...
                <form name="detalle" action="#" id="frmCompra">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="id_cliente" id="id_cliente" value="1" class="form-control"/><!--SESIONES PARA EL CLIENTE-->
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Fecha Inicio</label>
                        <div>
                            <input type="date" name="fecha_inicio" id="fecha_inicio" value="" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Fecha Final</label>
                        <div>
                            <input type="date" name="fecha_final" id="fecha_final" value="" class="form-control"/>
                        </div>
                    </div>
                ...
                <table class="table table-bordered" id="data2" width="100%" cellspacing="0">
                    ...
                    <%
                        if(request.getAttribute("prestamo")!=null){
                            ArrayList<Prestamo> a = new ArrayList<Prestamo>();
                            a.addAll((Collection)request.getAttribute("prestamo"));
                            for(Prestamo v:a){
                                
                                out.println("<tr>"
                                                    + "<td>"+v.getId_prestamo()+"</td>"
                                                    + "<td>"+v.getFecha_inicio()+"</td>"
                                                    + "<td>"+v.getFecha_fin()+"</td>"
                                                    + "<td>"+v.getTotal()+"</td>"
                                                    + "<td>"+v.getUsuario().getId_usuario()+"</td>"
                                                    + "<td>"+v.getUsuario().getUsuario()+"</td>"
                                                    + "<td>"
                                                        + "<a href='ControlPrestamo?cargar="+v.getId_prestamo()+"&idUsuario="+v.getUsuario().getId_usuario()+"' class='btn btn-secondary text-light' >Cargar</a>"
                                                    + "</td>"
                                            + "</tr>");
...
<!-- Page level plugins -->
  ...
  %>
  <script>
      $("#id_detalle_prestamo").val(<%= request.getAttribute("id")%>);
